...
class getNelmioAlice_FixtureBuilder_Denormalizer_FlagParser_RegistryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.fixture_builder.denormalizer.flag_parser.registry'] = new \Nelmio\Alice\FixtureBuilder\Denormalizer\FlagParser\FlagParserRegistry([0 => ($container->privates['nelmio_alice.fixture_builder.denormalizer.flag_parser.chainable.configurator'] ??= new \Nelmio\Alice\FixtureBuilder\Denormalizer\FlagParser\Chainable\ConfiguratorFlagParser()), 1 => ($container->privates['nelmio_alice.fixture_builder.denormalizer.flag_parser.chainable.extend'] ??= new \Nelmio\Alice\FixtureBuilder\Denormalizer\FlagParser\Chainable\ExtendFlagParser()), 2 => ($container->privates['nelmio_alice.fixture_builder.denormalizer.flag_parser.chainable.optional'] ??= new \Nelmio\Alice\FixtureBuilder\Denormalizer\FlagParser\Chainable\OptionalFlagParser()), 3 => ($container->privates['nelmio_alice.fixture_builder.denormalizer.flag_parser.chainable.template'] ??= new \Nelmio\Alice\FixtureBuilder\Denormalizer\FlagParser\Chainable\TemplateFlagParser()), 4 => ($container->privates['nelmio_alice.fixture_builder.denormalizer.flag_parser.chainable.unique'] ??= new \Nelmio\Alice\FixtureBuilder\Denormalizer\FlagParser\Chainable\UniqueFlagParser())]);
    }
}
