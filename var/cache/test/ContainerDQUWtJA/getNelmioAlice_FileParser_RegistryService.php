...
class getNelmioAlice_FileParser_RegistryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.file_parser.registry'] = new \Nelmio\Alice\Parser\ParserRegistry([0 => ($container->privates['nelmio_alice.file_parser.chainable.yaml'] ?? $container->load('getNelmioAlice_FileParser_Chainable_YamlService')), 1 => ($container->privates['nelmio_alice.file_parser.chainable.php'] ??= new \Nelmio\Alice\Parser\Chainable\PhpParser()), 2 => ($container->privates['nelmio_alice.file_parser.chainable.json'] ??= new \Nelmio\Alice\Parser\Chainable\JsonParser())]);
    }
}
