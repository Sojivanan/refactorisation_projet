...
class getFidryAliceDataFixtures_Persistence_PurgerFactory_DoctrineService extends App_KernelTestDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['fidry_alice_data_fixtures.persistence.purger_factory.doctrine'] = $container->createProxy('PurgerGhost3f56f99', fn () => \PurgerGhost3f56f99::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
