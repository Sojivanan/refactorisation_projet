...
class getFidryAliceDataFixtures_Loader_DoctrineService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['fidry_alice_data_fixtures.loader.doctrine'] = $container->createProxy('PurgerLoaderGhostF717e5a', fn () => \PurgerLoaderGhostF717e5a::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
