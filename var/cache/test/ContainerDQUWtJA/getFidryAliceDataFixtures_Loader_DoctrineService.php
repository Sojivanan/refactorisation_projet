...
class getFidryAliceDataFixtures_Loader_DoctrineService extends App_KernelTestDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['fidry_alice_data_fixtures.loader.doctrine'] = $container->createProxy('PurgerLoaderGhostBf8f105', fn () => \PurgerLoaderGhostBf8f105::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
