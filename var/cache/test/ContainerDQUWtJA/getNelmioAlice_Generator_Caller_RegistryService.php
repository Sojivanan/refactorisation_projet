...
class getNelmioAlice_Generator_Caller_RegistryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.generator.caller.registry'] = new \Nelmio\Alice\Generator\Caller\CallProcessorRegistry([0 => ($container->privates['nelmio_alice.generator.caller.chainable.configurator_method_call'] ??= new \Nelmio\Alice\Generator\Caller\Chainable\ConfiguratorMethodCallProcessor()), 1 => ($container->privates['nelmio_alice.generator.caller.chainable.method_call_with_reference'] ??= new \Nelmio\Alice\Generator\Caller\Chainable\MethodCallWithReferenceProcessor()), 2 => ($container->privates['nelmio_alice.generator.caller.chainable.optional_method_call'] ??= new \Nelmio\Alice\Generator\Caller\Chainable\OptionalMethodCallProcessor()), 3 => ($container->privates['nelmio_alice.generator.caller.chainable.simple_call'] ??= new \Nelmio\Alice\Generator\Caller\Chainable\SimpleMethodCallProcessor())]);
    }
}
