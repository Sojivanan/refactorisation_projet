...
class getFidryAliceDataFixtures_Loader_SimpleService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['fidry_alice_data_fixtures.loader.simple'] = $container->createProxy('SimpleLoaderGhostAde30c0', fn () => \SimpleLoaderGhostAde30c0::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
        ...
        return ($lazyLoad->__construct(($container->services['nelmio_alice.files_loader'] ?? $container->load('getNelmioAlice_FilesLoaderService')), ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService'))) && false ?: $lazyLoad);
    }
}
