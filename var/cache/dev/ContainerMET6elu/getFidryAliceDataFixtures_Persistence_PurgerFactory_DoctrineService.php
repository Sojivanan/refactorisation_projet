...
class getFidryAliceDataFixtures_Persistence_PurgerFactory_DoctrineService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['fidry_alice_data_fixtures.persistence.purger_factory.doctrine'] = $container->createProxy('PurgerGhostBdff7a6', fn () => \PurgerGhostBdff7a6::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
