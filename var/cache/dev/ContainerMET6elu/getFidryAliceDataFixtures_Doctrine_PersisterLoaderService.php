...
class getFidryAliceDataFixtures_Doctrine_PersisterLoaderService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['fidry_alice_data_fixtures.doctrine.persister_loader'] = $container->createProxy('PersisterLoaderGhost66374b8', fn () => \PersisterLoaderGhost66374b8::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
