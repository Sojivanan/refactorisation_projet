...
class getFidryAliceDataFixtures_Persistence_Persister_DoctrineService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['fidry_alice_data_fixtures.persistence.persister.doctrine'] = $container->createProxy('ObjectManagerPersisterGhostDc56936', fn () => \ObjectManagerPersisterGhostDc56936::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
